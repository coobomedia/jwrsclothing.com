    ...
    return (
      <div className="flex flex-col gap-6">
        <section className="flex  flex-col items-start gap-4">
          ...
          <p className=" text-lg italic text-primary-700 sm:text-xl">
            {searchQuery}
          </p>
        </section>
        ...
        <div className="flex min-h-[25vh] items-center justify-center ">
          <div role="status">
            <svg
              aria-hidden="true"
              className={`h-12 w-12 animate-spin fill-primary-300 text-primary-700`}
              viewBox="0 0 100 101"
              fill="none"
  ...
  if (!data?.filteredPosts || data?.filteredPosts.length < 1) {
    return (
      <div className="flex flex-col gap-6">
        ...
        <Separator className="my-4 " />
        <div className="mt-10 ">
          <h2 className="s mt-4 text-2xl font-bold tracking-tight text-primary-900">
            Sorry
          </h2>
